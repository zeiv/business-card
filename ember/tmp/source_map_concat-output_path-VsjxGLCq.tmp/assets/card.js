...
define('card/services/ajax', ['exports', 'ember-ajax/services/ajax'], function (exports, _emberAjaxServicesAjax) {
  Object.defineProperty(exports, 'default', {
    enumerable: true,
    get: function get() {
...
if (!runningTests) {
  require("card/app")["default"].create({"name":"card","version":"0.0.0+dcdef11d"});
}
