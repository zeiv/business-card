...
define('card/tests/routes/contact.jshint', ['exports'], function (exports) {
  ...
  QUnit.test('should pass jshint', function (assert) {
    assert.expect(1);
    assert.ok(false, 'routes/contact.js should pass jshint.\nroutes/contact.js: line 23, col 24, \'response\' is defined but never used.\nroutes/contact.js: line 21, col 28, \'grecaptcha\' is not defined.\nroutes/contact.js: line 28, col 9, \'grecaptcha\' is not defined.\n\n3 errors');
  });
});
